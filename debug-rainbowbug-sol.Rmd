...
# das bringt komischerweise aber nichts, außer dass eine legende geplottet wird
colnames(x) <- 1:80
#hier ensteht wohl der bug. Auch durch die Warnung erkannt: 'In fds(x = t_grid, y = x) : Please assign column name for the data matrix.'
